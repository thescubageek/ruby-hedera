    ...
    module Topics
      class MessagesController < Api::V1::ApplicationController
        ...
        def index
          ...
          response = self.class.get("/api/v1/topics/#{params.require(:topic_id)}/messages", query: filtered_params(params))
        ...
        def show
          response = self.class.get("/api/v1/topics/#{params.require(:topic_id)}/messages/#{params[:sequence_number]}")
